  ...
  document.getElementById('downloadReact').onclick = () => {
    FigmaAPIKeyInput = <HTMLInputElement>(document.getElementById('accessToken'));
    FigmaFileIDInput = <HTMLInputElement>(document.getElementById('figmaId'));
    componentNameInput = <HTMLInputElement>(document.getElementById('componentName'));
